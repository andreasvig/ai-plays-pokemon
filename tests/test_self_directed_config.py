...
def test_config_4_0_is_no_longer_the_default_but_still_loads():
    ...
    `pokemon run` resolves to. The default is now simply the highest config-X.Y
    (config-6.0, the SkyEmu backend, since 2026-09-20) — and the point of keeping a test here is the
