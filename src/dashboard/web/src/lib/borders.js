...
export const MEASURED = {
  // black-us: nothing drawn, every side held back —
  // Map317 held back, no border block: up 1.00, down 0.50, left 1.00, right 0.33
  // nothing is drawn for this map; to draw it anyway: '317:0': ['up', 'down', 'left', 'right'],
  // Map319 held back, no border block: down 0.50, left 0.00, right 0.50
  // nothing is drawn for this map; to draw it anyway: '319:0': ['down', 'left', 'right'],
  // Map389 held back, no border block: down 0.00, right 0.00
  // nothing is drawn for this map; to draw it anyway: '389:0': ['down', 'right'],
  // Map397 held back, no border block: right 0.00
  // nothing is drawn for this map; to draw it anyway: '397:0': ['right'],
  // black2-us: nothing drawn, every side held back —
  // Map427 held back, no border block: down 0.00, left 0.00, right 0.00
  // nothing is drawn for this map; to draw it anyway: '427:0': ['down', 'left', 'right'],
  'crystal-us': {
    '24:3': ['up', 'down'],                 // ROUTE_29 — fit up 1.00 down 0.90
  ...
  // Route201 held back, no border block: up 0.00, down 0.00
  // nothing is drawn for this map; to draw it anyway: '342:0': ['up', 'down'],
  // Route202 held back, no border block: left 0.00, right 0.00
  // nothing is drawn for this map; to draw it anyway: '343:0': ['left', 'right'],
  // Route219 held back, no border block: left 0.00, right 0.00
  // nothing is drawn for this map; to draw it anyway: '391:0': ['left', 'right'],
  // TwinleafTown held back, no border block: down 0.00, left 0.00, right 0.00
  // nothing is drawn for this map; to draw it anyway: '411:0': ['down', 'left', 'right'],
  // SandgemTown held back, no border block: right 0.00
